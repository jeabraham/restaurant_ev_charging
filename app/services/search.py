...
class DiningChargerService:
    ...
    async def find(self, payload: FindDiningChargersRequest) -> dict[str, Any]:
        ...
        async def fetch_places(
            ...
            # Always supplement Geoapify with Google Places when a Google client is
            # configured.  This fills coverage gaps (e.g. Lloydminster, Watrous) where
            # Geoapify returns no catering data, and also improves results in places
            # where both sources have coverage.
